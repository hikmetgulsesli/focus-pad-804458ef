...
- Focus Pad turns the user's request into a directly usable web workflow. The first experience must be the actual web product behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a tiny one-page utility called Focus Pad. It should show a title, one text input, a save icon button, and remember the note in local state. Keep it simple.
...
- Record Operations - Focus Pad
- Record Editor - Focus Pad
- Insights - Focus Pad

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Record Operations - Focus Pad
...
SCREEN_SPEC_2:
- exact_screen_title: Record Editor - Focus Pad
...
SCREEN_SPEC_3:
- exact_screen_title: Insights - Focus Pad
